...
function M.info()
  ...
  lines[#lines + 1] = "```"
  GogoVIM.info(lines, { title = "GogoVIM Roots" })
...
function M.setup()
  vim.api.nvim_create_user_command("LazyRoot", function()
    GogoVIM.root.info()
  end, { desc = "GogoVIM roots for the current buffer" })
  ...
  vim.api.nvim_create_autocmd({ "LspAttach", "BufWritePost", "DirChanged", "BufEnter" }, {
    group = vim.api.nvim_create_augroup("gogovim_root_cache", { clear = true }),
