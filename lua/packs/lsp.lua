GogoVIM.AddPack({ src = GogoVIM.GH("rafamadriz/friendly-snippets"), name = "friendly-snippets", data = { skip_load = true } })
GogoVIM.AddPack({
...
GogoVIM.AddPack({
    ...
    data = {
        ...
        opts = {
            ...
            build_tags =
            "functional,integration,unit,functional_1,functional_2,functional_3,functional_4,functional_5,functional_6,functional_http,functional_grpc",
            lsp_cfg = false,
            lsp_inlay_hints = {
                enable = true,
