        ...
        config = function()
            ...
            local opts = {
                options = {
                    ...
                    disabled_filetypes = { statusline = { "dashboard", "alpha", "ministarter", "Avante", "AvanteSelectedFiles", "AvanteTodos" } },
                },
                sections = {
                    lualine_a = { "mode" },
                    lualine_b = { "branch" },
        ...
        config = function()
            ...
            require("fzf-lua").setup({
                ...
                files = {
                    ...
                    fd_opts =
                    [[--color=always --type f --type l --exclude .git --exclude .jj --exclude node_modules --exclude vendor]],
                    rg_opts =
                    [[--hidden --files --column --line-number --no-heading --sort-files --color=always --smart-case -g '!{.git,node_modules,vendor,.jj}/*']],
                },
                grep = {
                    input_prompt = "RipGrep",
                    rg_opts      =
                    [[--hidden --column --line-number --no-heading --sort-files --max-columns=4096 --color=always --smart-case -g '!{.git,node_modules,vendor,.jj}/*']],
                    actions      = {
                        ["ctrl-g"] = false,
...
-- Which-Key
GogoVIM.AddPack({
    src = GogoVIM.GH("folke/which-key.nvim"),
    name = "which-key.nvim",
    data = {
        name = "which-key",
        config = function()
